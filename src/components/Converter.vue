...
<script setup>
  ...
  const games = ["Apex Legends", "ARK: Survival Evolved", "Battlefield 1", "Battlefield 2042", "Battlefield 4", "Battlefield 6", "Battlefield V", "Call of Duty: Black Ops 6", "Call of Duty: Modern Warfare 3 (2023)", "Call of Duty: Warzone", "Counter Strike 2", "Delta Force", "Team Fortress 2", "Valorant"]
